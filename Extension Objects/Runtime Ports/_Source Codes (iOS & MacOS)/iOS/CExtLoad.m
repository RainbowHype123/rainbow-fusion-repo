...
#import "CRunAdvComment.h"
#import "CRuncommentor.h"
...
//F02 			
    ...
    if ([name caseInsensitiveCompare:@"AdvComment"]==0)
    {
        object=[[CRunAdvComment alloc] init];
    }
    if ([name caseInsensitiveCompare:@"commentor"]==0)
    {
        object=[[CRuncommentor alloc] init];
    }
    if ([name caseInsensitiveCompare:@"OpenURLs"]==0)
    {
        object=[[CRunOpenURLs alloc] init];
    }
