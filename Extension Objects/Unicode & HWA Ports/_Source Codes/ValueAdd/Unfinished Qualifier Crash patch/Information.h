...
#define	ObjectName			_T("Value-Add Object")
#define	ObjectAuthor		_T("Gareth Ben Martin of Dynamic Arcade")
#define	ObjectCopyright		_T("Copyright \xA9 2008-2026 Dynamic Arcade")
#define	ObjectComment		_T("Provides unlimited Alterable Values and Strings for all objects.")
#define	ObjectURL			_T("http://www.dynamicarcade.co.uk")
#define	ObjectHelp			_T("Help\\ValueAdd\\ValueAdd.html")
