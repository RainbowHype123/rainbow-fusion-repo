...
long WINAPI DLLExport GetAsText(LPRDATA rdPtr, long param1)
{
	...
	static TCHAR temp[66]=""; //_i64toa docs say that it can never write more than 65 chars + null
...
{
	TCHAR* p1=(TCHAR*)CNC_GetFirstExpressionParameter(rdPtr, param1, TYPE_STRING);
