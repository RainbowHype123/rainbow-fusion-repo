...
//	MessageBox(0, "This is a warning that the \"Select Object Extension\" used in this file is a BETA, and as such should not be used in any released products, commercial or otherwise. You may not distribute this object neither alone nor in another file (eg archive or program). If you obtained this object (or a file containing it) anywhere except the Clickteam forums, please report it to TheThiefMaster@btinternet.com immediately.\n\nThankyou, and have a nice day.", "Select Object Extension", MB_OK);
