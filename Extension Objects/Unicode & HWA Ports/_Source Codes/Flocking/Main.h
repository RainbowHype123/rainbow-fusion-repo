...
#include <vector>
#include <hash_map> // May have to replace with <unordered_map>
#include <map>
...
/*
void Debug( TCHAR * string, int value );
void Debug( TCHAR * string, float value );
void Debug( TCHAR * string, float valueA, float valueB );
...
void LoopNeighbourBoids(LPRDATA rdPtr, TCHAR* loopname, Boid boid, int radius);
