...
typedef struct tagRDATA
{
	...
	TCHAR *					LastFuncName;			// For condition comparisons | Updated to TCHAR
...
// Default flags
// -------------
#define	OEFLAGS (OEFLAG_VALUES | OEFLAG_NEVERKILL | OEFLAG_RUNBEFOREFADEIN)
#define	OEPREFS 0
