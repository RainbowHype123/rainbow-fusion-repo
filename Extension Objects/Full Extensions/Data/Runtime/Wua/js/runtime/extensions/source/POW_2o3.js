/*
	This POW 2o3 Fusion extension UWP port is under MIT license.
*/
...
function CRunPOW_2o3() {
	...
	*/
	...
	this.Expression_SquareParam = function (IntInput) {
		return IntInput * IntInput;
	};
	this.Expression_CubeParam = function (IntInput) {
		return IntInput * IntInput * IntInput;
	};
	this.Expression_PowFunc = function (BaseInput, ExpInput) {
		return Math.pow(ExpInput, BaseInput);
	};
	...
	/* 0 */ this.Expression_SquareParam,
	/* 1 */ this.Expression_CubeParam,
	/* 2 */ this.Expression_PowFunc
	];
}
//
CRunPOW_2o3.prototype = {
...
CServices.extend(CRunExtension, CRunPOW_2o3);
