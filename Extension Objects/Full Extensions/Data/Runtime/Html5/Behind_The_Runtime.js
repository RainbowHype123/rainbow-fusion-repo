/*
	This Behind The Runtime Fusion extension HTML5 port is under MIT license.
...
/** @constructor */
function CRunBehind_The_Runtime() {
	...
	this['DebugMode'] = true;
	this['ExtensionName'] = 'Behind The Runtime';
	...
	// Actions
	// ======================================================================================================
	this.Action_Comment = function (CommentParameter) {
		// nothing, as C++ does nothing
	};
	this.Action_CommentObject = function (CommentParameter) {
		// nothing, as C++ does nothing
	};
	...
	// Conditions
	// ======================================================================================================
	this.Condition_Comment = function (CommentParameter) {
		// nothing, as this ext purposefully does nothing
	};
	this.Condition_CommentObject = function (CommentParameter) {
		// nothing, as this ext purposefully does nothing
	};
	...
	this.Expression_CommentStr = function (CommentParameter) {
		return "";
	};
	this.Expression_CommentInt = function (CommentParameter) {
		return 0;
	};
	...
	this.$actionFuncs = [
	/* 0 */ this.Action_Comment,
	/* 1 */ this.Action_CommentObject
	];
	this.$conditionFuncs = [
	/* 0 */ this.Condition_Comment,
	/* 1 */ this.Condition_CommentObject

	// update getNumOfConditions function if you edit this!!!!
	];
	this.$expressionFuncs = [
	/* 0 */ this.Expression_CommentStr,
	/* 1 */ this.Expression_CommentInt
	];
}
//
CRunBehind_The_Runtime.prototype = CServices.extend(new CRunExtension(), {
	...
	getNumberOfConditions: function() {
		...
		return 2; // $conditionFuncs not available yet
	},
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to Behind The Runtime.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to Behind The Runtime.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to Behind The Runtime.";
		}
