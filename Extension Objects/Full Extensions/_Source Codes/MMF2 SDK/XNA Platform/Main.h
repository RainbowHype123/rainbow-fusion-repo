...
#define IDENTIFIER	MAKEID(X,N,A,P)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
...
// ------------------------------
#define	CND_RUNNINGONPC				0
#define	CND_RUNNINGONXBOX			1
#define	CND_RUNNINGONPHONE			2
#define	CND_LAST					3
