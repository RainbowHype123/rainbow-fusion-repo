...
short conditionsInfos[]=
		{
		IDMN_CND_RUNNINGONPC, M_CND_RUNNINGONPC, CND_RUNNINGONPC, EVFLAGS_ALWAYS + EVFLAGS_NOTABLE, 0,
		IDMN_CND_RUNNINGONXBOX, M_CND_RUNNINGONXBOX, CND_RUNNINGONXBOX, EVFLAGS_ALWAYS + EVFLAGS_NOTABLE, 0,
		IDMN_CND_RUNNINGONPHONE, M_CND_RUNNINGONPHONE, CND_RUNNINGONPHONE, EVFLAGS_ALWAYS + EVFLAGS_NOTABLE, 0,
		};
...
long WINAPI DLLExport RunningOnPc(LPRDATA rdPtr, long param1, long param2)
{
	return false;
}

long WINAPI DLLExport RunningOnXbox(LPRDATA rdPtr, long param1, long param2)
{
	return false;
}

long WINAPI DLLExport RunningOnPhone(LPRDATA rdPtr, long param1, long param2)
{
	return false;
}
