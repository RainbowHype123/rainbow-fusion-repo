...
public:
	...
	*/
	...
	void ActionComment(const TCHAR * Comment);
	void ActionCommentObject(const TCHAR * Comment);

	// Conditions

	const TCHAR * ConditionComment(const TCHAR * Comment);
	const TCHAR * ConditionCommentObject(const TCHAR * Comment);

	// Expressions

	const TCHAR * ExpressionCommentStr(const TCHAR * Comment);
	int ExpressionCommentInt(int Comment);
