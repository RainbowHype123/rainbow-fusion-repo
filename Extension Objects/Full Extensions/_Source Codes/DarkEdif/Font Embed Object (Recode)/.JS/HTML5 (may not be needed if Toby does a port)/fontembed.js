/*
	This Font Embed Object Fusion extension HTML5 port is under MIT license.
...
function CRunfontembed() {
	...
	this['DebugMode'] = true;
	this['ExtensionName'] = 'Font Embed Object';
...
//
CRunfontembed.prototype = CServices.extend(new CRunExtension(), {
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to Font Embed Object.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to Font Embed Object.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to Font Embed Object.";
		}
