/*
	This UUID Generator Fusion extension HTML5 port is under MIT license.
...
function CRunUUID_Generator() {
	...
	this['DebugMode'] = true;
	this['ExtensionName'] = 'UUID Generator';
...
//
CRunUUID_Generator.prototype = CServices.extend(new CRunExtension(), {
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to UUID Generator.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to UUID Generator.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to UUID Generator.";
		}
