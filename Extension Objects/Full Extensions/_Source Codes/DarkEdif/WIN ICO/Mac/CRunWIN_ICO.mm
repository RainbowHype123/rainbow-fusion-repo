...
#import "CRunWIN_ICO.hpp"

@implementation CRunWIN_ICO : CRunExtension

-(id)init
{
	if (++initedWIN_ICOCPP == 1)
		WIN_ICO_init();
	return [super init];
}
-(void)dealloc
...
-(int)getNumberOfConditions
{
	...
	return WIN_ICO_getNumberOfConditions();
}
-(BOOL)createRunObject:(CFile*)file withCOB:(CCreateObjectInfo*)cob andVersion:(int)version
{
	if (initedWIN_ICOCPP == 0)
		NSLog(@"Init for WIN ICO was never run!");
	NSLog(@"CreateRunObject for WIN ICO");
	...
	cptr = WIN_ICO_createRunObject(edPtr, cob, version, self);
	if (!cptr)
		NSLog(@"Failed to createRunObject for WIN ICO!");
	free(edPtr);
	return cptr != NULL;
}
-(int)handleRunObject
{
	return WIN_ICO_handleRunObject(cptr);
}
-(void)destroyRunObject:(BOOL)bFast
{
	WIN_ICO_destroyRunObject(cptr, bFast);
	cptr = NULL;
	[expRet dealloc];
}
-(BOOL)condition:(int)paramNum withCndExtension:(CCndExtension*)cnd
{
	...
	// by checking num and the return of WIN_ICO_conditionJump, which is either a 32-bit integer,
	...
	return WIN_ICO_conditionJump(cptr, paramNum, cnd) != 0;
}
-(void)action:(int)paramNum withActExtension:(CActExtension*)act
{
	WIN_ICO_actionJump(cptr, paramNum, act);
}
-(CValue*)expression:(int)paramNum
{
	WIN_ICO_expressionJump(cptr, paramNum);
	return expRet;
}
-(void)pauseRunObject
{
	WIN_ICO_pauseRunObject(cptr);
}
-(void)continueRunObject
{
	WIN_ICO_continueRunObject(cptr);
}
...
extern "C" {
	...
	void DarkEdif_WIN_ICO_generateEvent(void * ext, int code, int param)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		[extRun->ho generateEvent:code withParam:param];
	}
	void DarkEdif_WIN_ICO_reHandle(void * ext)
	{
		CRunExtension * extRun = (CRunWIN_ICO *)ext;
		[extRun->ho reHandle];
	}

	int DarkEdif_WIN_ICO_actGetParamExpression(void * ext, void * act, int paramNum, int paramType)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		...
		if (paramType == 29)
		{
			...
			{
				printf("WIN_ICO: DarkEdif_actGetParamExpression passed a direction %d which cannot translate into NewDirection bitmask. Using no direction.", result);
				return 0;
			}
			return 1 << result;
		}
		...
		if (paramType != 22)
			printf("WIN_ICO: DarkEdif_actGetParamExpression: Unknown param type %d requested. Defaulting to Expression.", paramType);
		return [actExt getParamExpression:extRun->rh withNum:paramNum];
	}
	const char * DarkEdif_WIN_ICO_actGetParamExpString(void * ext, void * act, int paramNum)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		CActExtension * actExt = (CActExtension *)act;
	...
	double DarkEdif_WIN_ICO_actGetParamExpDouble(void * ext, void * act, int paramNum)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		CActExtension * actExt = (CActExtension *)act;
	...
	int DarkEdif_WIN_ICO_cndGetParamExpression(void * ext, void * cnd, int paramNum, int paramType)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		...
		if (paramType == 29)
		{
			...
			if (result < 0 || result > 31)
			{
				printf("WIN_ICO: DarkEdif_cndGetParamExpression passed a direction %d which cannot translate into NewDirection bitmask. Using no direction.", result);
				return 0;
			}
			return 1 << result;
		}
		...
		// ParamExpression is 22; at the moment, no other types are expected
		if (paramType != 22)
			printf("WIN_ICO: DarkEdif_cndGetParamExpression: Unknown param type %d requested. Defaulting to Expression.", paramType);
		return [cndExt getParamExpression:extRun->rh withNum:paramNum];
	}
	const char * DarkEdif_WIN_ICO_cndGetParamExpString(void * ext, void * cnd, int paramNum)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		CCndExtension * cndExt = (CCndExtension *)cnd;
	...
	double DarkEdif_WIN_ICO_cndGetParamExpDouble(void * ext, void * cnd, int paramNum)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		CCndExtension * cndExt = (CCndExtension *)cnd;
	...
	int DarkEdif_WIN_ICO_expGetParamInt(void * ext)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		return [[extRun->ho getExpParam] getInt];
	}
	const char * DarkEdif_WIN_ICO_expGetParamString(void * ext)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		return [[[extRun->ho getExpParam] getString] UTF8String];
	}
	float DarkEdif_WIN_ICO_expGetParamFloat(void * ext)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		return (float)[[extRun->ho getExpParam] getDouble];
	}

	void DarkEdif_WIN_ICO_expSetReturnInt(void * ext, int i)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		[extRun->expRet forceInt:i];
	}
	void DarkEdif_WIN_ICO_expSetReturnString(void * ext, const char * str)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		[extRun->expRet forceString:[NSString stringWithUTF8String:str]];
	}
	void DarkEdif_WIN_ICO_expSetReturnFloat(void * ext, float f)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
		[extRun->expRet forceDouble:(double)f];
	}

	void DarkEdif_WIN_ICO_freeString(void * ext, const char * cstr)
	{
		[(NSString*)cstr release];
	}

	int DarkEdif_WIN_ICO_getCurrentFusionEventNum(void * ext)
	{
		CRunWIN_ICO * extRun = (CRunWIN_ICO *)ext;
	...
	char * DarkEdif_WIN_ICO_makePathUnembeddedIfNeeded(void * ext, const char * fileName)
	{
	...
	void * DarkEdif_WIN_ICO_getCPtr(void * ext)
	{
		CRunWIN_ICO * const extRun = (CRunWIN_ICO *)((CExtension *)ext)->ext;

		// While we cast this to CRunWIN_ICO, it may be any sort of CRun, including one that doesn't have cptr.
		...
		{
			printf("WIN_ICO: DarkEdif_getCPtr passed an invalid, non-DarkEdif ext.\n");
			return NULL;
		}
		return extRun->cptr;
	}
