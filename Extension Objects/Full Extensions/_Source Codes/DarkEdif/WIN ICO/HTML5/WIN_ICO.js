/*
	This WIN ICO Fusion extension HTML5 port is under MIT license.
...
//
CRunWIN_ICO.prototype = CServices.extend(new CRunExtension(), {
	...
	condition: function(num, cnd) {
		...
		if (func == null) {
			throw "Unrecognised condition ID " + (~~num) + " passed to WIN ICO.";
		}
	...
	action: function(num, act) {
		...
		if (func == null) {
			throw "Unrecognised action ID " + (~~num) + " passed to WIN ICO.";
		}
	...
	expression: function(num) {
		...
		if (func == null) {
			throw "Unrecognised expression ID " + (~~num) + " passed to WIN ICO.";
		}
