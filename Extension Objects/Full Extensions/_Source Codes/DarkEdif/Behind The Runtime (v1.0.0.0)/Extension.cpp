...
#endif
{
	...
	*/
	...
	LinkAction(1, ActionCommentObject);

	LinkCondition(0, ConditionComment);
	LinkCondition(1, ConditionCommentObject);

	LinkExpression(0, ExpressionCommentStr);
	LinkExpression(1, ExpressionCommentInt);
	...
	*/
	...
	// I DISABLED THESE REFERENCES TO THE PROPERTIES FOR NOW, THEY'RE CAUSING ERRORS AND IDK WHAT IS WRONG
	// -RH
