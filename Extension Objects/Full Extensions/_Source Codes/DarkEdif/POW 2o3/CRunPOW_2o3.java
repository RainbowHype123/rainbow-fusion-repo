/* File generated by DarkEdifPostBuildTool v1.0.1.1, part of DarkEdif SDK. 
   ...
   Copyright of the POW 2o3 extension and all rights reserved by the creator(s) of POW 2o3.
   
   A native extension needs a Java file to generate a Java class. The class is empty,
   and a native is assumed by presence of CRunPOW_2o3 in the assets folder.
...
public class CRunPOW_2o3 extends CRunExtension
{
	...
	public CRunPOW_2o3()
	{
		if (!inited)
		{
			String libName = "POW_2o3";

			try
			{
				android.util.Log.v("POW_2o3", "Loading POW 2o3 extension from \"app/main/jniLibs/" + MMFRuntime.inst.ABI + "/lib" + libName + ".so\"...");
				System.loadLibrary(libName);

				android.util.Log.v("POW_2o3", "Loaded POW 2o3 extension OK!");

				inited = true;
			}
			catch (UnsatisfiedLinkError e)
			{
				android.util.Log.e("POW_2o3", "Couldn't load extension POW 2o3, library lib" + libName + ".so couldn't be loaded: " + e.toString());
			}
		}
	}
	...
	public boolean createRunObject(CBinaryFile file, CCreateObjectInfo cob, int version)
	{
		...
		if (cptr == 0)
			android.util.Log.e("POW_2o3", "POW 2o3's createRunObject returned NULL!");
	...
	public native void darkedif_pauseRunObject(long cptr);
	...
	public native void darkedif_continueRunObject(long cptr);
	...
	public int darkedif_jni_getActionOrConditionIntParam(CEvent evt, int paramIndex, int paramType)
	{
		if (!(evt instanceof CCndExtension) && !(evt instanceof CActExtension))
			android.util.Log.e("POW_2o3", "darkedif_jni_getActionOrConditionIntParam: The CEvent is not CActExtension or CCndExtension. Type is \"" + evt.getClass().getSimpleName() + "\".");
		if (paramIndex == -1)
			android.util.Log.e("POW_2o3", "darkedif_jni_getActionOrConditionIntParam: paramIndex -1.");
		...
		if (paramType == 29)
		{
			...
			{
				android.util.Log.e("POW_2o3", "darkedif_jni_getActionOrConditionIntParam: Passed a direction " + result + " which cannot translate into NewDirection bitmask. Using no direction.");
				return 0;
			}
			return 1 << result;
		}
		...
		if (paramType != 22)
			android.util.Log.w("POW_2o3", "darkedif_jni_getActionOrConditionIntParam: Unknown param type " + paramType + " requested. Defaulting to Expression.");
		return this.rh.get_EventExpressionInt((CParamExpression)evt.evtParams[paramIndex]);
	}
}
